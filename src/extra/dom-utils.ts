...
function findClosestNode(baseElement: Element, selector: string, direction: string, coneAngle = CONE_ANGLE) {
    ...
    const nodes = Array.from(baseElement.ownerDocument.querySelectorAll(selector));
